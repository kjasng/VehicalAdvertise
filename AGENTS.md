...
- **Package manager & UI (pnpm + shadcn/ui)**: `./.claude/rules/package-manager-and-ui.md`
- And other workflows: `./.claude/rules/*`

## Critical rules (non-negotiable)

- **Package manager**: pnpm ONLY. Never `npm` or `yarn`. See `./.claude/rules/package-manager-and-ui.md`.
- **UI system**: shadcn/ui only. Add via `pnpm dlx shadcn@latest add <component>`. See same file.
